...
All cross-references use relative markdown links. Never use the old `UC-*`, `DC-*`, `DE-*` prefixed identifiers in catalog entries. Reference artifacts by their display name with a link to their path.
