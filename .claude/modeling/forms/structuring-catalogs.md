...
Structural contract for catalog documents — index format, entry layout, cross-references, and ordering. Defines the artifact shape for both reading and writing catalogs. Load when writing or reviewing catalog files.
