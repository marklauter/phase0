...
description: Create, write, stub, or scaffold shared invariant files — rules, constraints, scope, rationale. Loads the invariant form contract and creation script.
---
