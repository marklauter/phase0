...
description: Create, write, stub, or scaffold use case files — scenarios, goals, invariants, domain events with proper structure. Loads the use case form contract and creation script.
---
