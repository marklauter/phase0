...
description: Create, write, or scaffold use case files — scenarios, goals, invariants, obstacles, domain events. Loads the use case form contract and creation script.
---
